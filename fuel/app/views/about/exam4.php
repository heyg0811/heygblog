    ...
    <div class="container about heyg-superblock">
            ...
            <div class="col-md-6">
                <dl class="dl-horizontal">
                    ...
                    <dt>サービス仕様</dt>
                    <dd>前述通り、家計簿機能と料理支援機能を更新するとトップ画面の鳥が成長する様になっています。</dd>
                    <dd>その他にガチャガチャで家具を取得出来たり、その家具を図鑑にて変更出来る様になっています。</dd>
                    <dd>家計簿は一般的な家計簿機能があり<br>料理支援機能はクックパッドを表示し、お気に入り機能と用語検索機能を付与してあります。</dd>
                </dl>
                <dl class="dl-horizontal">
                    <dt>制作人数</dt>
                    <dd>4人</dd>
